...
- (void)wm_setup {
    ...
    _titleColorSelected = ThemeColorBlue;
    _titleColorNormal   = ThemeColorLine;
...
- (void)wm_addMenuView {
    ...
    menuView.qlTextAlignment = self.qlTextAlignment;
    ...
    if (self.menuViewColor) {
        menuView.backgroundColor = self.menuViewColor;
    }
