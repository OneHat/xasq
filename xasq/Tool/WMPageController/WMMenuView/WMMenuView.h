...
typedef NS_ENUM(NSUInteger, QLTextAlignment) {
    QLTextAlignmentCenter,  // Visually centered
    QLTextAlignmentRight,   // Visually right aligned
    QLTextAlignmentLeft,    // Visually right aligned
};
...
@property (nonatomic, assign) QLTextAlignment qlTextAlignment;
